...
/**
 * This program extends Part B using animation.
 * The sky starts out dark and the sun rises from behind the tree
 * going towards the top. The sky gradually changes from dark to light.
 * Created on February 16th, 2026
 */

import processing.core.*;

public class Lab1CPrinceEzeoma extends PApplet {
    int barnX = 300;
    int barnY = 170;
    int barnW = 100;
    int barnH = 100;
    ...
    public static void main(String[] args){
        PApplet.main("Lab1CPrinceEzeoma");
    }
